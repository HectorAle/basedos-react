      ...
      <nav className={`${style.navbarLine} navbar is-white` } role='navigation' aria-label='main navigation'>
        <div className={`navbar-brand ${style.menu} `}>
          <a className='navbar-item' href='https://bulma.io'>
            <img src={logo} width='112' height='28' alt='Reactjs'/>
          </a>
            ...
            <div className='column is-12'>
              <div className='card events-card'>
                ...
                <header className='card-header'>
                    ...
                    <a href='!#' target="#" className='card-header-icon' aria-label='more options'>
                        <span className='icon'>
                ...
                <footer className='card-footer'>
                    <a href='!#' target="#" className='card-footer-item'>View All</a>
                </footer>
